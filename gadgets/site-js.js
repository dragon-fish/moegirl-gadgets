...
(function () {
    ...
    function listMarginLeft() {
        $(".mw-parser-output ul:not(.margin-left-set), .mw-parser-output ol:not(.margin-left-set)").each(function (_, ele) {
            var $ele = $(ele);
    ...
    $(function () {
        ...
        if (!wgUserGroups.includes("autoconfirmed") && wgCurRevisionId > 0 && wgRevisionId > 0 && wgCurRevisionId !== wgRevisionId) {
